...
public class TestMongoPOJO {
	...
	public void insertOne() {
		...
		PostVO vo=new PostVO(null, "Kim", "오늘도 수고욤", "2022-12-13");
		mcol.insertOne(vo);
	...
	public void findByAuthor() {
		...
		//PostVO vo1=cursor.first(); //처음꺼만 가져오기
	...
	public void findeOneAndReplace() {
		mcol=mdb.getCollection(table, PostVO.class);
		FindIterable<PostVO> cursor= mcol.find(eq("author", "King"));
		String  id = cursor.first().getId();
	...
	public static void main(String[] args) {
		...
		//app.updateMany();
		//app.replaceOne();
		app.findeOneAndReplace();
		System.out.println("------수정 처리 후 -------------");
		app.findAll();
	}
